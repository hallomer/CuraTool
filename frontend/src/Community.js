...
const Community = () => {
    ...
    return (
        ...
        <div className="community-container">
            ...
            <div className="posts">
                {posts.length === 0 ? (
                    <p className="no-content-message">No posts here yet! Be the first to share your ideas, questions, or guides.</p>
                ) : ( 
                    posts.map((post) => {
                                ...
                                {expandedPosts[post._id] && (
                                    <div className="comments">
                                        {post.comments.length === 0 ? (
                                            <p className="no-content-message">No comments yet—join the conversation and share your thoughts!</p>
                                        ) : (
